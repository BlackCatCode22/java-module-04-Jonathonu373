...
public class Main {
    public static void main(String[] args) {
        ...
        public class timeAndAnimalClass {
            ...
            Animal myNewAnimal = new Animal(sex "male", age 4, weight 70, animalName "Zig", animalID "Hy01". AnimalBirthdate "2020-3-21", animalColor "brown spots", animalOrigin "from San Diego Zoo");

            // Prove it
            System.out.println("this is the new animal!")
            System.out.println("\n ID is: " + myNewAnimal.getAnimalID() + " and...name is: Zig " + myNewAnimal.getAnimalName() + "\n"
